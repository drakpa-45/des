...
(function (e, t) {
    ...
    e.ui = e.ui || {}, e.extend(e.ui, {
        ...
        var n = "Width" === s ? ["Left", "Right"] : ["Top", "Bottom"], o = s.toLowerCase(), r = {
...
(function (e, t) {
    ...
    e.ui = e.ui || {};
    var a, o = Math.max, r = Math.abs, h = Math.round, l = /left|center|right/, u = /top|center|bottom/, d = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, p = /%$/, f = e.fn.position;
    e.position = {
        ...
        t = e.extend({}, t);
        var a, p, m, g, v, y, b = e(t.of), _ = e.position.getWithinInfo(t.within), x = e.position.getScrollInfo(_), w = (t.collision || "flip").split(" "), k = {};
        return y = n(b), b[0].preventDefault && (t.at = "left top"), p = y.width, m = y.height, g = y.offset, v = e.extend({}, g), e.each(["my", "at"], function () {
            var e, i, s = (t[this] || "").split(" ");
            1 === s.length && (s = l.test(s[0]) ? s.concat(["center"]) : u.test(s[0]) ? ["center"].concat(s) : ["center", "center"]), s[0] = l.test(s[0]) ? s[0] : "center", s[1] = u.test(s[1]) ? s[1] : "center", e = d.exec(s[0]), i = d.exec(s[1]), k[this] = [e ? e[0] : 0, i ? i[0] : 0], t[this] = [c.exec(s[0])[0], c.exec(s[1])[0]]
            ...
            var n, l, u = e(this), d = u.outerWidth(), c = u.outerHeight(), f = s(this, "marginLeft"), y = s(this, "marginTop"), D = d + f + s(this, "marginRight") + x.width, T = c + y + s(this, "marginBottom") + x.height, S = e.extend({}, v), M = i(k.my, u.outerWidth(), u.outerHeight());
            "right" === t.my[0] ? S.left -= d : "center" === t.my[0] && (S.left -= d / 2), "bottom" === t.my[1] ? S.top -= c : "center" === t.my[1] && (S.top -= c / 2), S.left += M[0], S.top += M[1], e.support.offsetFractions || (S.left = h(S.left), S.top = h(S.top)), n = {
                marginLeft: f,
                marginTop: y
                ...
                var i = g.left - S.left, s = i + p - d, n = g.top - S.top, a = n + m - c, h = {
                    target: {
                        element: b,
                        left: g.left,
                        top: g.top,
                    ...
                    element: {element: u, left: S.left, top: S.top, width: d, height: c},
                    horizontal: 0 > s ? "left" : i > 0 ? "right" : "center",
                    vertical: 0 > a ? "top" : n > 0 ? "bottom" : "middle"
                };
                d > p && p > r(i + s) && (h.horizontal = "center"), c > m && m > r(n + a) && (h.vertical = "middle"), h.important = o(r(i), r(s)) > o(r(n), r(a)) ? "horizontal" : "vertical", t.using.call(this, e, h)
...
(function (e) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _convertPositionTo: function (t, i) {
            i || (i = this.position);
            var s = "absolute" === t ? 1 : -1, a = "absolute" !== this.cssPosition || this.scrollParent[0] !== document && e.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent;
        ...
        start: function (t, i) {
            var s = e(this).data("ui-draggable"), a = s.options, n = e.extend({}, i, {item: s.element});
            ...
            var s = e(this).data("ui-draggable"), a = e.extend({}, i, {item: s.element});
            ...
            var s = e(this).data("ui-draggable"), a = this;
            e.each(s.sortables, function () {
                var n = !1, o = this;
        ...
        start: function (t, i) {
            var s = e(i.helper), a = e(this).data("ui-draggable").options;
        ...
        start: function () {
            ...
            var i = e(this).data("ui-draggable"), s = i.options, a = !1;
        ...
        start: function () {
            ...
            var s, a, n, o, r, h, l, u, d, c, p = e(this).data("ui-draggable"), f = p.options, m = f.snapTolerance, g = i.offset.left, v = g + p.helperProportions.width, y = i.offset.top, b = y + p.helperProportions.height;
            for (d = p.snapElements.length - 1; d >= 0; d--)r = p.snapElements[d].left, h = r + p.snapElements[d].width, l = p.snapElements[d].top, u = l + p.snapElements[d].height, r - m > v || g > h + m || l - m > b || y > u + m || !e.contains(p.snapElements[d].item.ownerDocument, p.snapElements[d].item) ? (p.snapElements[d].snapping && p.options.snap.release && p.options.snap.release.call(p.element, t, e.extend(p._uiHash(), {snapItem: p.snapElements[d].item})), p.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(l - b), a = m >= Math.abs(u - y), n = m >= Math.abs(r - v), o = m >= Math.abs(h - g), s && (i.position.top = p._convertPositionTo("relative", {
                ...
                top: 0,
                left: h
            }).left - p.margins.left)), c = s || a || n || o, "outer" !== f.snapMode && (s = m >= Math.abs(l - y), a = m >= Math.abs(u - b), n = m >= Math.abs(r - g), o = m >= Math.abs(h - v), s && (i.position.top = p._convertPositionTo("relative", {
                top: l,
                left: 0
            }).top - p.margins.top), a && (i.position.top = p._convertPositionTo("relative", {
            ...
            }).left - p.margins.left)), !p.snapElements[d].snapping && (s || a || n || o || c) && p.options.snap.snap && p.options.snap.snap.call(p.element, t, e.extend(p._uiHash(), {snapItem: p.snapElements[d].item})), p.snapElements[d].snapping = s || a || n || o || c)
        }
...
(function (e) {
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _mouseDrag: function (t) {
            var i, s = this.helper, n = {}, a = this.originalMousePosition, o = this.axis, r = this.position.top, h = this.position.left, l = this.size.width, u = this.size.height, d = t.pageX - a.left || 0, c = t.pageY - a.top || 0, p = this._change[o];
        ...
        _respectSize: function (e) {
            ...
            return o && (e.width = t.minWidth), r && (e.height = t.minHeight), n && (e.width = t.maxWidth), a && (e.height = t.maxHeight), o && u && (e.left = h - t.minWidth), n && u && (e.left = h - t.maxWidth), r && d && (e.top = l - t.minHeight), a && d && (e.top = l - t.maxHeight), e.width || e.height || e.left || !e.top ? e.width || e.height || e.top || !e.left || (e.left = null) : e.top = null, e
        },
        ...
        start: function () {
            var i, s, n, a, o, r, h, l = e(this).data("ui-resizable"), u = l.options, d = l.element, c = u.containment, p = c instanceof e ? c.get(0) : /parent/.test(c) ? d.parent().get(0) : c;
            ...
            var i, s, n, a, o = e(this).data("ui-resizable"), r = o.options, h = o.containerOffset, l = o.position, u = o._aspectRatio || t.shiftKey, d = {
                top: 0,
                left: 0
...
(function (e) {
    ...
    e.widget("ui.button", {
        ...
        _resetButton: function () {
            ...
            var t = this.buttonElement.removeClass(s), i = e("<span></span>", this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(t.empty()).text(), a = this.options.icons, n = a.primary && a.secondary, o = [];
...
(function (e) {
    ...
    e.widget("ui.dialog", {
        ...
        _makeResizable: function () {
            ...
            var i = this, s = this.options, a = s.resizable, n = this.uiDialog.css("position"), o = "string" == typeof a ? a : "n,e,s,w,se,sw,ne,nw";
